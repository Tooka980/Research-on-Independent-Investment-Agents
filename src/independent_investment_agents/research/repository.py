...
class ResearchRepository:
        ...
        with self._connect() as conn:
            ...
            self._ensure_columns(
                ...
                "decision_contexts",
                {
                    ...
                    "bullish_reasons_ja": "TEXT NOT NULL DEFAULT '[]'",
                    "bearish_reasons_ja": "TEXT NOT NULL DEFAULT '[]'",
                    "invalidation_conditions_ja": "TEXT NOT NULL DEFAULT '[]'",
        ...
        with self._connect() as conn:
            ...
            conn.execute(
                ...
                INSERT INTO decision_contexts (
                    ...
                    bullish_reasons, bearish_reasons, unknowns, counterarguments, invalidation_conditions,
                    alternative_scenarios, what_would_change_our_mind, recommended_holding_period,
                    stop_loss_plan, take_profit_plan, position_size_reason, reason_ja,
                    bullish_reasons_ja, bearish_reasons_ja, invalidation_conditions_ja, expected_return,
                ...
                (
                    ...
                    decision.reason_ja,
                    json_dumps(decision.bullish_reasons_ja),
                    json_dumps(decision.bearish_reasons_ja),
                    json_dumps(decision.invalidation_conditions_ja),
    ...
    def _row_to_decision(self, row: sqlite3.Row) -> DecisionContext:
        return DecisionContext(
            ...
            unknowns=[str(item) for item in json_loads_list(row["unknowns"])],
            ...
            bullish_reasons_ja=[str(item) for item in json_loads_list(row["bullish_reasons_ja"])],
            bearish_reasons_ja=[str(item) for item in json_loads_list(row["bearish_reasons_ja"])],
            invalidation_conditions_ja=[str(item) for item in json_loads_list(row["invalidation_conditions_ja"])],
